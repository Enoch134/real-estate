...
export const location = [
  ...
  {
    id: 4,
    name: "Central Business Unit, Freetown",
    Villas: "12 Villas",
    Apartments: " 10 Apartments",
    Offices: "07 Offices",
...
export const footer = [
  ...
  {
    title: "ALL SECTIONS",
    text: [{ list: "Buy" }, { list: "Sell" }, { list: "Rent" }, { list: "Lease" },],
  },
  {
    title: "COMPANY",
    text: [{ list: "About" }, { list: "Blog" }, { list: "Service"},{ list: "Testimonies"}],
  },
]